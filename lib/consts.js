...
consts.WELCOME_INFO = ["\nWelcome to pome interactive client.",
...
consts.HELP_LOGIN = [
	"\nWelcome to pome interactive client.",
	"pome is a fast, scalable game server framework for node.js. ",
	"You can use following command to connect to pome master",
	"pome-cli -h host -P port -u user -p password",
	"Default type pome-cli equals to:",
	"pome-cli -h 127.0.0.1 -P 3005 -u admin -p admin\n"
];
...
consts.COMANDS_ALL = [
	...
	["add", "  add server to pome clusters"],
...
consts.COMANDS_MAP = {
	...
	"config": ["\nconfig infos like : proxy, remote, connection, connector, session",
			...
			"in pome you can pass opt config to component to make your like-style server",
